        ...
        <form onSubmit={handleSave}>
          ...
          <div style={sectionStyle}>
            ...
            >
              ...
              <div>
                <label htmlFor="lot_size" style={labelStyle}>
                  LOT SIZE
                </label>
                <input
                  name="lot_size"
              ...
              <div>
                <label htmlFor="entry_time" style={labelStyle}>
                  ENTRY TIME
                </label>
                <input
                  name="entry_time"
              ...
              <div>
                <label htmlFor="exit_time" style={labelStyle}>
                  EXIT TIME
                </label>
                <input
                  name="exit_time"
          ...
          <div style={sectionStyle}>
            ...
            >
              <div>
                <label htmlFor="pnl" style={labelStyle}>
                  P&L (USD)
                </label>
                <input
                  name="pnl"
              ...
              <div>
                <label htmlFor="risk_amount" style={labelStyle}>
                  RISK AMOUNT (USD)
                </label>
                <input
                  name="risk_amount"
          ...
          <div style={sectionStyle}>
            ...
            <div style={{ marginBottom: "12px" }}>
              <label htmlFor="strategy" style={labelStyle}>
                STRATEGY
              </label>
              <select
                name="strategy"
